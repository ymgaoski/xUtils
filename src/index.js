...
export {deffrence} from './array/deffrence'
...
// 事件相关的 API 函数
export {addEventListener} from './event/bind'
...
// 对象相关的 API 函数
export {clone,deepClone} from './object/clone'
...
// 字符串相关的 API 函数
export {reverseString,loopString,truncate} from './string/index'
